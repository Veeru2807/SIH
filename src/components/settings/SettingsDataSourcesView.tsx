        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">
              Manage data ingestion pipelines, production REST API endpoints, and synthetic data mode.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="terminal-card p-5 space-y-4">
          <div className="border-b border-[#1e3362] pb-2.5 flex items-center justify-between">
            ...
            <span className="text-xs font-mono font-bold text-amber-400">
              {demoMode ? 'Synthetic Active' : 'Live Connected'}
            </span>
          </div>

          <div className="space-y-3 text-xs">
            <div className="flex items-center justify-between p-3 rounded bg-[#0c1630] border border-[#1e3362]">
              <div>
                <span className="font-semibold text-slate-100 block">SIH 2026 Demo Data Mode</span>
                <span className="text-slate-400 text-[11px]">
                  Uses realistic synthetic market fixtures for demonstration without requiring live Baltic Exchange API tokens.
                </span>
              </div>
              <input
                type="checkbox"
